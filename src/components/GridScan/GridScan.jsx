...
export const GridScan = ({
  ...
  /* face-api.js is ~700KB and is only ever touched when enableWebcam is on, so
     it is imported on demand rather than at module scope. Backgrounds that leave
     the webcam off never download it. */
  ...
  useEffect(() => {
    ...
    /* Used as a full-bleed background, the container can resize without the window
       doing so (sidebar collapse, scrollbar appearing), so watch the element too. */
